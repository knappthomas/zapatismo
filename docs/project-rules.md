...
- **README:** Keep root `README.md` minimal but sufficient to clone, install, and run the app (and point to `docs/` for details).
...
| **Repo**        | Monorepo; no secrets in repo; docs in `docs/`. |
